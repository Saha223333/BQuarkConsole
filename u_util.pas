...
If Main.RGType.ItemIndex=0 then
 begin
  ...
  Main.WorkFileMemo.Lines.Add(chr(9)+chr(9)+'TYPE=COLUMN; WIDTH=40; TITLE=PLC-адрес; VALUE=PROPERTY; FILTER=ADDR');
  Main.WorkFileMemo.Lines.Add(chr(9)+chr(9)+'TYPE=COLUMN; WIDTH=100; TITLE=Улица; VALUE=PROPERTY; FILTER=Улица');
  Main.WorkFileMemo.Lines.Add(chr(9)+chr(9)+'TYPE=COLUMN; WIDTH=30; TITLE=Дом; VALUE=PROPERTY; FILTER=Дом');
  ...
  Main.WorkFileMemo.Lines.Add(chr(9)+chr(9)+'TYPE=COLUMN; WIDTH=120; TITLE=Показания T4; VALUE=BINDATA; FILTER=T4'+CBFlagStr);
